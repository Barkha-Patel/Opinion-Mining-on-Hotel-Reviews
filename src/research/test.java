...
class ParserDemo {
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 0) {
      demoAPI(lp,"it has great battery life , fm radio , excellent signal , hands free speakerphone ( which i have to say is probably my favorite function ) and downloadable java apps.");
    } else {
   ...
   */
  public static void demoAPI(LexicalizedParser lp,String s) {
